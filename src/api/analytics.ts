...
const normalizeAdminAgentOverview = (data: Partial<AdminAgentOverviewVO> = {}): AdminAgentOverviewVO => ({
  ...
  degradedAgentRuns: Number(data.degradedAgentRuns || 0),
  effectiveAgentRuns: Number(data.effectiveAgentRuns || data.successAgentRuns || 0),
  agentSuccessRate: Number(data.agentSuccessRate || 0),
  effectiveSuccessRate: Number(data.effectiveSuccessRate || data.agentSuccessRate || 0),
