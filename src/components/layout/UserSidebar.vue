...
const menuItems = [
  ...
  { label: 'V4 个人分析', path: '/analytics/personal', icon: TrendCharts },
  { label: 'Agent 复盘', path: '/agent/reviews', icon: DocumentChecked },
  { label: '成长档案', path: '/growth/profile', icon: Medal },
  { label: '长期记忆', path: '/agent/memory', icon: MagicStick },
  { label: 'Personal Knowledge', path: '/knowledge', icon: Reading },
