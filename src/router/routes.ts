...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/404', name: 'NotFound', component: () => import('@/views/error/NotFoundView.vue'), meta: { public: true, title: '页面不存在' } },
  {
    ...
    children: [
      ...
      { path: 'dashboard', name: 'Dashboard', component: () => import('@/views/user/ArenaHomeView.vue'), meta: { title: '今天' } },
      ...
      { path: 'questions/practice', name: 'QuestionPractice', component: () => import('@/views/question/QuestionPracticeSessionView.vue'), meta: { title: '专项训练房间' } },
      ...
      { path: 'questions/recommendations', name: 'QuestionRecommendations', component: () => import('@/views/question/ArenaTrainView.vue'), meta: { title: '训练' } },
      ...
      { path: 'resumes', name: 'ResumeJobHub', component: () => import('@/views/resume/ArenaPrepareView.vue'), meta: { title: '准备' } },
      ...
      { path: 'resumes/create', name: 'ResumeCreate', component: () => import('@/views/resume/ResumeEditView.vue'), meta: { title: '简历编辑工作台' } },
      { path: 'resumes/:id/edit', name: 'ResumeEdit', component: () => import('@/views/resume/ResumeEditView.vue'), meta: { title: '简历编辑工作台' } },
      ...
      { path: 'interviews/create', name: 'InterviewCreate', component: () => import('@/views/interview/ArenaInterviewCreateView.vue'), meta: { title: '面试' } },
