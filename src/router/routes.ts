...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/404', name: 'NotFound', component: () => import('@/views/error/NotFoundView.vue'), meta: { public: true, title: '页面不存在' } },
  {
    ...
    children: [
      ...
      { path: 'resumes', name: 'ResumeJobHub', component: () => import('@/views/resume/ResumeJobHubView.vue'), meta: { title: '简历与岗位' } },
      ...
      { path: 'ability-map', name: 'AbilityMap', component: () => import('@/views/ability-map/AbilityMapView.vue'), meta: { title: '能力地图' } },
