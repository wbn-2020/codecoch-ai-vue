...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/404', name: 'NotFound', component: () => import('@/views/error/NotFoundView.vue'), meta: { public: true, title: '页面不存在' } },
  {
    ...
    children: [
      ...
      { path: 'questions/favorites', name: 'FavoriteQuestions', component: () => import('@/views/question/FavoriteQuestionView.vue'), meta: { title: '收藏复习' } },
      ...
      { path: 'resumes/create', name: 'ResumeCreate', component: () => import('@/views/resume/ResumeEditView.vue'), meta: { title: '简历编辑工作台', arenaTheme: true } },
      { path: 'resumes/:id/edit', name: 'ResumeEdit', component: () => import('@/views/resume/ResumeEditView.vue'), meta: { title: '简历编辑工作台', arenaTheme: true } },
      ...
      { path: 'project-evidence', name: 'ProjectEvidenceList', component: () => import('@/views/project-evidence/ProjectEvidenceListView.vue'), meta: { title: '项目证据库' } },
      ...
      { path: 'tools', name: 'RecordsTools', component: () => import('@/views/tools/RecordsToolsView.vue'), meta: { title: '记录与工具', arenaTheme: true } },
      { path: 'arena/leaderboard', name: 'ArenaLeaderboard', component: () => import('@/views/arena/ArenaLeaderboardView.vue'), meta: { title: '排行榜' } },
      { path: 'arena/battle', name: 'ArenaBattle', component: () => import('@/views/arena/ArenaBattleView.vue'), meta: { title: '多人竞技' } },
