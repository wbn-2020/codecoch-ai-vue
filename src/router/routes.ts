...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/404', name: 'NotFound', component: () => import('@/views/error/NotFoundView.vue'), meta: { public: true, title: '页面不存在' } },
  {
    ...
    children: [
      ...
      { path: 'questions/recommendations', name: 'QuestionRecommendations', component: () => import('@/views/question/QuestionTrainingHubView.vue'), meta: { title: '今日训练题组' } },
      ...
      { path: 'resumes', name: 'ResumeJobHub', component: () => import('@/views/resume/ResumeJobHubSafeView.vue'), meta: { title: '简历实验' } },
      ...
      { path: 'interviews/room/:id', name: 'InterviewRoom', component: () => import('@/views/interview/InterviewRoomView.vue'), meta: { title: 'AI 面试训练室' } },
