...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai/questions/generate', name: 'AdminAiQuestionGenerate', component: () => import('@/views/admin/QuestionManageView.vue'), props: { initialGovernanceTab: 'generate' }, meta: { title: 'AI 题目生成', icon: 'Operation', requiredPermissions: ['admin:question:generate'] } },
      { path: 'question-reviews', name: 'AdminQuestionReviews', component: () => import('@/views/admin/QuestionManageView.vue'), props: { initialGovernanceTab: 'reviews' }, meta: { title: '题目审核', icon: 'DataAnalysis', requiredPermissions: ['admin:question:review'] } },
      { path: 'question-duplicate-reviews', name: 'AdminQuestionDuplicateReviews', component: () => import('@/views/admin/QuestionManageView.vue'), props: { initialGovernanceTab: 'duplicates' }, meta: { title: '题目去重审核', icon: 'Connection', requiredPermissions: ['admin:question:dedupe'] } },
