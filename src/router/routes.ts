...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/404', name: 'NotFound', component: () => import('@/views/error/NotFoundView.vue'), meta: { public: true, title: '页面不存在' } },
  {
    ...
    children: [
      ...
      { path: 'onboarding', name: 'UserOnboarding', component: () => import('@/views/user/UserOnboardingView.vue'), meta: { title: '新手引导', hidden: true, commandHidden: true } },
      {
        path: 'dashboard/v3',
        name: 'V3Dashboard',
      ...
      { path: 'weakness-analysis', name: 'WeaknessAnalysis', component: () => import('@/views/user/WeaknessAnalysisView.vue'), meta: { title: '薄弱点分析', arenaTheme: true } },
      { path: 'projects', redirect: '/project-evidence', meta: { title: '项目经历（已并入我的项目）', hidden: true, commandHidden: true } },
      { path: 'questions', name: 'QuestionList', component: () => import('@/views/question/QuestionListView.vue'), meta: { title: '题库浏览', commandHidden: true } },
      { path: 'questions/practice', name: 'QuestionPractice', component: () => import('@/views/question/QuestionPracticeSessionView.vue'), meta: { title: '专项训练房间', arenaTheme: true } },
      { path: 'questions/wrong-records', name: 'WrongQuestions', component: () => import('@/views/question/WrongQuestionView.vue'), meta: { title: '错题复盘' } },
      { path: 'questions/favorites', name: 'FavoriteQuestions', component: () => import('@/views/question/FavoriteQuestionView.vue'), meta: { title: '收藏复习', hidden: true, commandHidden: true } },
      { path: 'questions/recommendations', name: 'QuestionRecommendations', component: () => import('@/views/question/ArenaTrainView.vue'), meta: { title: '训练', arenaTheme: true } },
      { path: 'questions/recommendations/legacy', name: 'QuestionRecommendationsLegacy', component: () => import('@/views/question/QuestionTrainingHubView.vue'), meta: { title: '今日训练题组（旧版）', hidden: true, commandHidden: true } },
      { path: 'questions/:id', name: 'QuestionDetail', component: () => import('@/views/question/QuestionTrainingDetailView.vue'), meta: { title: '题目训练工作区' } },
      ...
      { path: 'project-evidence', name: 'ProjectEvidenceList', component: () => import('@/views/project-evidence/ProjectEvidenceListView.vue'), meta: { title: '我的项目' } },
      { path: 'project-evidence/create', name: 'ProjectEvidenceCreate', component: () => import('@/views/project-evidence/ProjectEvidenceEditView.vue'), meta: { title: '新建项目' } },
      { path: 'project-evidence/:id', name: 'ProjectEvidenceDetail', component: () => import('@/views/project-evidence/ProjectEvidenceDetailView.vue'), meta: { title: '项目详情' } },
      { path: 'project-evidence/:id/edit', name: 'ProjectEvidenceEdit', component: () => import('@/views/project-evidence/ProjectEvidenceEditView.vue'), meta: { title: '编辑项目' } },
      { path: 'evidence-assets',
        name: 'EvidenceAssets',
        component: () => import('@/views/evidence-assets/EvidenceAssetsView.vue'),
        meta: { title: '证据资产工作台', featureFlag: 'v9EvidenceLearning', hidden: true, commandHidden: true }
      },
      ...
      { path: 'application-packages', name: 'ApplicationPackageList', component: () => import('@/views/application-package/ApplicationPackageListView.vue'), meta: { title: '投递包列表', hidden: true, commandHidden: true } },
      { path: 'application-packages/preview', name: 'ApplicationPackagePreview', component: () => import('@/views/application-package/ApplicationPackageDetailView.vue'), meta: { title: '岗位投递包', hidden: true, commandHidden: true } },
      ...
      { path: 'ability-map', name: 'AbilityMap', component: () => import('@/views/ability-map/AbilityMapView.vue'), meta: { title: '能力图谱', arenaTheme: true } },
      { path: 'interviews', redirect: '/interviews/history', meta: { hidden: true, commandHidden: true } },
      { path: 'interviews/create', name: 'InterviewCreate', component: () => import('@/views/interview/ArenaInterviewCreateView.vue'), meta: { title: '面试', arenaTheme: true } },
      { path: 'interviews/create/legacy', name: 'InterviewCreateLegacy', component: () => import('@/views/interview/InterviewCreateView.vue'), meta: { title: '推荐开练（旧版）', hidden: true, commandHidden: true } },
      ...
      { path: 'interviews/:id/report', name: 'InterviewReport', component: () => import('@/views/interview/InterviewReportView.vue'), meta: { title: '面试报告', arenaTheme: true } },
      ...
      { path: 'daily-tasks', name: 'DailyTasks', component: () => import('@/views/study/DailyTaskView.vue'), meta: { title: '每日任务', hidden: true, commandHidden: true } },
      { path: 'tools', redirect: '/dashboard', meta: { title: '记录与工具（已下线）', hidden: true, commandHidden: true } },
      { path: 'arena/leaderboard', redirect: '/analytics/personal', meta: { title: '训练统计', hidden: true, commandHidden: true } },
      { path: 'arena/battle', redirect: '/questions/practice', meta: { title: '协作练习（已下线）', hidden: true, commandHidden: true } },
      { path: 'offer-help', redirect: '/tools', meta: { hidden: true } },
      { path: 'analytics/personal', name: 'PersonalAnalytics', component: () => import('@/views/analytics/PersonalAnalyticsView.vue'), meta: { title: '训练分析', hidden: true, commandHidden: true } },
      ...
      { path: 'agent/tasks', name: 'AgentTasks', component: () => import('@/views/agent/AgentTaskListView.vue'), meta: { title: '任务中心', hidden: true, commandHidden: true } },
      { path: 'agent/runs', redirect: '/agent/today', meta: { hidden: true, commandHidden: true } },
      { path: 'job-experiments', redirect: '/dashboard', meta: { title: '求职实验台（已下线）', hidden: true, commandHidden: true } },
      { path: 'job-experiments/create', redirect: '/dashboard', meta: { hidden: true, commandHidden: true } },
      { path: 'job-experiments/:id/edit', redirect: '/dashboard', meta: { hidden: true, commandHidden: true } },
      { path: 'job-experiments/:id/review', redirect: '/dashboard', meta: { hidden: true, commandHidden: true } },
      { path: 'job-experiments/:id', redirect: '/dashboard', meta: { hidden: true, commandHidden: true } },
      { path: 'portfolio-demo', name: 'PortfolioDemo', component: () => import('@/views/portfolio-demo/PortfolioDemoView.vue'), meta: { title: '作品集演示模式', hidden: true, commandHidden: true } },
