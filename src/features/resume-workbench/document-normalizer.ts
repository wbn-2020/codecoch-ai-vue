...
export const normalizeResumeDocument = (input: unknown): ResumeDocumentV2 | null => {
  ...
  return {
    ...
    layout: {
      ...
      fontScale: clampNumber(layout.fontScale, 0.8, 1.3, 1),
      lineHeight: clampNumber(layout.lineHeight, 1, 2.2, 1.5),
      sectionSpacing: clampNumber(layout.sectionSpacing, 4, 28, 12),
      pageMarginPt: clampNumber(layout.pageMarginPt, 20, 60, 36),
