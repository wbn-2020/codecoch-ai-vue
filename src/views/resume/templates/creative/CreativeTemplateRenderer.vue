  ...
  <TemplatePaper :model="model" variant="modern" class="creative-renderer">
    ...
    <main v-if="sections.length" class="creative-renderer__body">
      <section
        ...
        :class="['creative-renderer__section', `creative-renderer__section--${section.builtinKey || 'custom'}`]"
      >
        <div class="creative-renderer__section-label">{{ section.title }}</div>

        <div v-if="section.builtinKey === 'summary'" class="creative-renderer__summary">
          <p v-for="paragraph in model.summary" :key="paragraph">{{ paragraph }}</p>
        </div>
        <div v-else-if="section.builtinKey === 'skills'" class="creative-renderer__skills">
          <div
