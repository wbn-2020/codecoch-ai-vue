...
const blockedPhrases = [
  ...
  { phrase: 'Agent daily review', reason: 'english-ui-copy' },
  { phrase: 'JOB SEARCH EXPERIMENT', reason: 'english-ui-copy' },
  { phrase: 'BUSINESS OBJECTS', reason: 'english-ui-copy' },
  { phrase: 'VARIANTS', reason: 'english-ui-copy' },
  { phrase: 'v2 hypothesis', reason: 'english-ui-copy' },
  { phrase: '成长画像', reason: 'terminology-copy' },
